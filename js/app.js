...
// CONFIG
var SUPA_URL='https://vwzppnjxbmkdknzxyrle.supabase.co';
var SUPA_KEY='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZ3enBwbmp4Ym1rZGtuenh5cmxlIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODI2NzA3OTEsImV4cCI6MjA5ODI0Njc5MX0.ClasZhTrDgt3ku8n88vhc3dxmPu2ZbVsoEu2uzLYBfY';
...
function setupListeners() {
  ...
  // TAB NAVIGATION - Using direct click handlers
  ...
  document.querySelectorAll('[data-message-key]').forEach(btn => {
    btn.onclick = () => {
      sendQuickMessage(btn.dataset.messageKey);
      return false;
    };
  });
  ...
  document.querySelectorAll('[data-symptom]').forEach(btn => {
    btn.onclick = () => {
      selectSymptom(btn.dataset.symptom, btn);
      return false;
    };
  });
